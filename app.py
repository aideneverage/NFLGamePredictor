...
# --- Sidebar Controls ---
st.sidebar.title("🏈 Matchup Selector")

# Select between 2025 and 2026
available_seasons = sorted([int(s) for s in df['season'].unique() if s >= 2025], reverse=True)
